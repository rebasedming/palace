...
export const SAFE_TILE = 0;
export const COLLISION_TILE = 1;
export const PRIZE_TILE = 2;
  ...
  ({
    ...
    return (
      <PixiStage
        ...
        className="absolute"
      >
        <Player map={map} setPlayerPrizePos={setPlayerPrizePos} />
      </PixiStage>
    );
  }
);
  ...
  return (
    <div className="bg-gray-600 relative overscroll-none flex justify-center items-center h-screen overflow-hidden">
      ...
      {/* {!DEBUG && (
        <>
          <Grid map={map} /> */}
      <PixStage world={world} map={map} setPlayerPrizePos={setPlayerPrizePos} />
      {/* </>
      )} */}
    </div>
  );
